...
types = int*_t, uint*_t, uint64x*_t
...
types = float32x2_t:uint32x2_t, float32x4_t:uint32x4_t
...
b = 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F
e = TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE
types = uint64x1_t, uint64x2_t, int64x1_t:uint64x1_t, int64x2_t:uint64x2_t, poly64x1_t:uint64x1_t, poly64x2_t:uint64x2_t
...
b = 1.2, 3.4, 5.6, 7.8
e = TRUE, TRUE, TRUE, TRUE, TRUE, TRUE
types = float64x1_t:uint64x1_t, float64x2_t:uint64x2_t
