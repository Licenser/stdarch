...
pub unsafe fn vrhadd_u8(a: uint8x8_t, b: uint8x8_t) -> uint8x8_t {
    ...
    extern "C" {
        ...
        fn vrhadd_u8_(a: uint8x8_t, a: uint8x8_t) -> uint8x8_t;
    }
vrhadd_u8_(a, b)
}
...
pub unsafe fn vrhaddq_u8(a: uint8x16_t, b: uint8x16_t) -> uint8x16_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_u8_(a: uint8x16_t, a: uint8x16_t) -> uint8x16_t;
    }
vrhaddq_u8_(a, b)
}
...
pub unsafe fn vrhadd_u16(a: uint16x4_t, b: uint16x4_t) -> uint16x4_t {
    ...
    extern "C" {
        ...
        fn vrhadd_u16_(a: uint16x4_t, a: uint16x4_t) -> uint16x4_t;
    }
vrhadd_u16_(a, b)
}
...
pub unsafe fn vrhaddq_u16(a: uint16x8_t, b: uint16x8_t) -> uint16x8_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_u16_(a: uint16x8_t, a: uint16x8_t) -> uint16x8_t;
    }
vrhaddq_u16_(a, b)
}
...
pub unsafe fn vrhadd_u32(a: uint32x2_t, b: uint32x2_t) -> uint32x2_t {
    ...
    extern "C" {
        ...
        fn vrhadd_u32_(a: uint32x2_t, a: uint32x2_t) -> uint32x2_t;
    }
vrhadd_u32_(a, b)
}
...
pub unsafe fn vrhaddq_u32(a: uint32x4_t, b: uint32x4_t) -> uint32x4_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_u32_(a: uint32x4_t, a: uint32x4_t) -> uint32x4_t;
    }
vrhaddq_u32_(a, b)
}
...
pub unsafe fn vrhadd_s8(a: int8x8_t, b: int8x8_t) -> int8x8_t {
    ...
    extern "C" {
        ...
        fn vrhadd_s8_(a: int8x8_t, a: int8x8_t) -> int8x8_t;
    }
vrhadd_s8_(a, b)
}
...
pub unsafe fn vrhaddq_s8(a: int8x16_t, b: int8x16_t) -> int8x16_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_s8_(a: int8x16_t, a: int8x16_t) -> int8x16_t;
    }
vrhaddq_s8_(a, b)
}
...
pub unsafe fn vrhadd_s16(a: int16x4_t, b: int16x4_t) -> int16x4_t {
    ...
    extern "C" {
        ...
        fn vrhadd_s16_(a: int16x4_t, a: int16x4_t) -> int16x4_t;
    }
vrhadd_s16_(a, b)
}
...
pub unsafe fn vrhaddq_s16(a: int16x8_t, b: int16x8_t) -> int16x8_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_s16_(a: int16x8_t, a: int16x8_t) -> int16x8_t;
    }
vrhaddq_s16_(a, b)
}
...
pub unsafe fn vrhadd_s32(a: int32x2_t, b: int32x2_t) -> int32x2_t {
    ...
    extern "C" {
        ...
        fn vrhadd_s32_(a: int32x2_t, a: int32x2_t) -> int32x2_t;
    }
vrhadd_s32_(a, b)
}
...
pub unsafe fn vrhaddq_s32(a: int32x4_t, b: int32x4_t) -> int32x4_t {
    ...
    extern "C" {
        ...
        fn vrhaddq_s32_(a: int32x4_t, a: int32x4_t) -> int32x4_t;
    }
vrhaddq_s32_(a, b)
}
...
pub unsafe fn vuqadd_s8(a: int8x8_t, b: int8x8_t) -> int8x8_t {
    ...
    extern "C" {
        ...
        fn vuqadd_s8_(a: int8x8_t, a: int8x8_t) -> int8x8_t;
    }
vuqadd_s8_(a, b)
}
...
pub unsafe fn vuqaddq_s8(a: int8x16_t, b: int8x16_t) -> int8x16_t {
    ...
    extern "C" {
        ...
        fn vuqaddq_s8_(a: int8x16_t, a: int8x16_t) -> int8x16_t;
    }
vuqaddq_s8_(a, b)
}
...
pub unsafe fn vuqadd_s16(a: int16x4_t, b: int16x4_t) -> int16x4_t {
    ...
    extern "C" {
        ...
        fn vuqadd_s16_(a: int16x4_t, a: int16x4_t) -> int16x4_t;
    }
vuqadd_s16_(a, b)
}
...
pub unsafe fn vuqaddq_s16(a: int16x8_t, b: int16x8_t) -> int16x8_t {
    ...
    extern "C" {
        ...
        fn vuqaddq_s16_(a: int16x8_t, a: int16x8_t) -> int16x8_t;
    }
vuqaddq_s16_(a, b)
}
...
pub unsafe fn vuqadd_s32(a: int32x2_t, b: int32x2_t) -> int32x2_t {
    ...
    extern "C" {
        ...
        fn vuqadd_s32_(a: int32x2_t, a: int32x2_t) -> int32x2_t;
    }
vuqadd_s32_(a, b)
}
...
pub unsafe fn vuqaddq_s32(a: int32x4_t, b: int32x4_t) -> int32x4_t {
    ...
    extern "C" {
        ...
        fn vuqaddq_s32_(a: int32x4_t, a: int32x4_t) -> int32x4_t;
    }
vuqaddq_s32_(a, b)
}
...
pub unsafe fn vhsub_u8(a: uint8x8_t, b: uint8x8_t) -> uint8x8_t {
    ...
    extern "C" {
        ...
        fn vhsub_u8_(a: uint8x8_t, a: uint8x8_t) -> uint8x8_t;
    }
vhsub_u8_(a, b)
}
...
pub unsafe fn vhsubq_u8(a: uint8x16_t, b: uint8x16_t) -> uint8x16_t {
    ...
    extern "C" {
        ...
        fn vhsubq_u8_(a: uint8x16_t, a: uint8x16_t) -> uint8x16_t;
    }
vhsubq_u8_(a, b)
}
...
pub unsafe fn vhsub_u16(a: uint16x4_t, b: uint16x4_t) -> uint16x4_t {
    ...
    extern "C" {
        ...
        fn vhsub_u16_(a: uint16x4_t, a: uint16x4_t) -> uint16x4_t;
    }
vhsub_u16_(a, b)
}
...
pub unsafe fn vhsubq_u16(a: uint16x8_t, b: uint16x8_t) -> uint16x8_t {
    ...
    extern "C" {
        ...
        fn vhsubq_u16_(a: uint16x8_t, a: uint16x8_t) -> uint16x8_t;
    }
vhsubq_u16_(a, b)
}
...
pub unsafe fn vhsub_u32(a: uint32x2_t, b: uint32x2_t) -> uint32x2_t {
    ...
    extern "C" {
        ...
        fn vhsub_u32_(a: uint32x2_t, a: uint32x2_t) -> uint32x2_t;
    }
vhsub_u32_(a, b)
}
...
pub unsafe fn vhsubq_u32(a: uint32x4_t, b: uint32x4_t) -> uint32x4_t {
    ...
    extern "C" {
        ...
        fn vhsubq_u32_(a: uint32x4_t, a: uint32x4_t) -> uint32x4_t;
    }
vhsubq_u32_(a, b)
}
...
pub unsafe fn vhsub_s8(a: int8x8_t, b: int8x8_t) -> int8x8_t {
    ...
    extern "C" {
        ...
        fn vhsub_s8_(a: int8x8_t, a: int8x8_t) -> int8x8_t;
    }
vhsub_s8_(a, b)
}
...
pub unsafe fn vhsubq_s8(a: int8x16_t, b: int8x16_t) -> int8x16_t {
    ...
    extern "C" {
        ...
        fn vhsubq_s8_(a: int8x16_t, a: int8x16_t) -> int8x16_t;
    }
vhsubq_s8_(a, b)
}
...
pub unsafe fn vhsub_s16(a: int16x4_t, b: int16x4_t) -> int16x4_t {
    ...
    extern "C" {
        ...
        fn vhsub_s16_(a: int16x4_t, a: int16x4_t) -> int16x4_t;
    }
vhsub_s16_(a, b)
}
...
pub unsafe fn vhsubq_s16(a: int16x8_t, b: int16x8_t) -> int16x8_t {
    ...
    extern "C" {
        ...
        fn vhsubq_s16_(a: int16x8_t, a: int16x8_t) -> int16x8_t;
    }
vhsubq_s16_(a, b)
}
...
pub unsafe fn vhsub_s32(a: int32x2_t, b: int32x2_t) -> int32x2_t {
    ...
    extern "C" {
        ...
        fn vhsub_s32_(a: int32x2_t, a: int32x2_t) -> int32x2_t;
    }
vhsub_s32_(a, b)
}
...
pub unsafe fn vhsubq_s32(a: int32x4_t, b: int32x4_t) -> int32x4_t {
    ...
    extern "C" {
        ...
        fn vhsubq_s32_(a: int32x4_t, a: int32x4_t) -> int32x4_t;
    }
vhsubq_s32_(a, b)
}
